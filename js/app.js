var map;
var sb;
var sbInput = document.getElementById('rest-searchbox');
		...
		*/
		LoadRestaurants(mapBounds, function (){
			...
			for (var k=0; k<functionList.length; k++){
				self.curYelp = functionList[k];
				//create the marker based on the Yelp coordinates
				createMarker(self.curYelp.location.coordinate.latitude, self.curYelp.location.coordinate.longitude, k);
